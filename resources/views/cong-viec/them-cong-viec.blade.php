...
@section('content')
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mt-2" id="ten_cong_viec" maxlength="255"
                                        name="ten_cong_viec" placeholder="Nhập tên công việc" required>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control mt-2" id="noi_nhan" maxlength="50"
                                    name="noi_nhan" placeholder="Nơi nhận" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <center>
                <button type="button" id="xacNhanBtn" class="btn btn-success mb-5">Thêm công việc</button>
            </center>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Xác nhận thêm công việc</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Xác nhận thêm công việc này?
                </div>
                <div class="modal-footer">
                    <form action="{{ route('cong-viec.them-cong-viec-submit') }}" method="POST" id="mainForm">
                        @csrf
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            nhapYeuCauButton.addEventListener('click', function() {
                ...
                if (tableRows.length === 0) {
                    alert('Vui lòng thêm ít nhất một thời hạn');
                    return;
                }
